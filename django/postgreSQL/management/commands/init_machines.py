...
from postgreSQL.models import Machine
...
machines=[
	...
	{'id': 8, 'name': 'Wenglor Profilsensor', 'location_id': None, 'image': '', 'topic': 'wenglor', 'model_3d': '', 'ipv4': None, 'parent_id': 5, 'connected_robot_id': None, 'x_position': 0.0, 'y_position': 0.0, 'z_position': 0.0, 'x_size': 0.0, 'y_size': 0.0, 'z_size': 0.0, 'ex_base_vector': '1 0 0', 'ey_base_vector': '0 1 0', 'ez_base_vector': '0 0 1', 'role': 'WENGLOR'}
]
